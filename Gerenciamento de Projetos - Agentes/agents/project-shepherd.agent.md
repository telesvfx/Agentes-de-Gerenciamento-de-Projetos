...
- **planning-and-task-breakdown** — para estruturar cronogramas e dependências em tarefas ordenadas.
- **idea-refine** — para lapidar propostas ainda vagas antes de comprometer um plano.
- **documentation-and-adrs** — para registrar decisões de coordenação relevantes.
...
Salve o documento final em `resultado/[project-name]-charter.md`.
...
Salve o relatório final em `resultado/[project-name]-status-report.md`.
