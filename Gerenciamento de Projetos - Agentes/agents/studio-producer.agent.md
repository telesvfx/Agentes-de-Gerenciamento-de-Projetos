...
- **idea-refine** — para lapidar decisões estratégicas de portfólio antes de comprometer recursos.
- **documentation-and-adrs** — para registrar decisões executivas relevantes.
...
Salve o plano final em `resultado/[period]-portfolio-plan.md`.
...
Salve a revisão final em `resultado/[period]-portfolio-review.md`.
